...
insert into person(id,name,age,address) values(hibernate_sequence.nextval,'小麦',25,'深圳');
insert into person(id,name,age,address) values(hibernate_sequence.nextval,'宝贝',24,'深圳');