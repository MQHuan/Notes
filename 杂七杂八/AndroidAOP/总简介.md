#### APT：Annotation processing tool 把注解，在编译时生成代码通过创建一个Processor(继承于AbstractProcessor) 来在编译的时候来处理注解的， 然后再配合上[JavaPoet](https://github.com/square/javapoet)  来生成自己想要的代码。
